...
export default class DraftForms extends React.Component { // eslint-disable-line react/prefer-stateless-function
    constructor(props) {
    super(props);

    this.state = { DraftForms:[
                ...
                <div className="page-content padding-30 container-fluid">
                  <div className="row" data-plugin="matchHeight" data-by-row="true">
                    <div className="col-md-12">
                      <h1 className="heading30">Draft Forms</h1>
                          ...
                          <div className="box-heading">
                            ...
                            <div className="box-content">
                              <ul className="list-unstyled">
                                  {
                                    this.state.DraftForms.map((item, index)=>(
                                        <li key={`item-${index}`}>
...
export default connect(mapStateToProps, null)(DraftForms);
